...
import { faMagnifyingGlass, faFile, faPercent, faHandshakeAngle, faUser, faCartShopping, faBars } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="p-5 drop-shadow-md border border-solid border-b-2 border-slate-100 sticky top-0 bg-white">
            <nav className='flex justify-between items-center'>
                ...
                <ul className='flex justify-end items-center gap-6 text-md font-normal text-slate-900'>
                    <Link to="/corporate">
