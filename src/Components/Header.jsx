...
const Header = () => {
    ...
    return (
        <nav className="md:p-5 p-3 drop-shadow-md border border-solid border-b-2 border-slate-100 sticky top-0 bg-white">
            <div className='md:flex justify-between items-center md:max-w-7xl mx-auto'>
                ...
                <div className={`flex md:block justify-end ${open ? 'block' : 'hidden'}`}>
                    <ul className='md:flex md:item-center md:gap-6 md:text-md text-xl font-normal text-slate-900 space-y-8 md:space-y-0'>
                        <Link to="/corporate">
